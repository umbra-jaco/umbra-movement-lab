        ...
        <div className="min-h-screen bg-void text-albedo pt-32 pb-24 px-6 md:px-12 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                <header className="mb-20">
                    ...
                    <p className="font-editorial text-lg text-albedo/50 leading-relaxed max-w-2xl">
                ...
                <form className="space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div className="group border-b border-white/10 focus-within:border-visceral-crimson transition-colors pb-2">
                            <label className="font-clinical text-[10px] tracking-[0.3em] uppercase text-albedo/30 block mb-2">Subject Name</label>
                            <input
                                type="text"
                                className="w-full bg-transparent font-clinical text-albedo placeholder:text-albedo/10 focus:outline-none uppercase tracking-widest"
                                placeholder="Last, First"
                            />
                        </div>
                        <div className="group border-b border-white/10 focus-within:border-visceral-crimson transition-colors pb-2">
                            <label className="font-clinical text-[10px] tracking-[0.3em] uppercase text-albedo/30 block mb-2">Electronic Path</label>
                            <input
                                type="email"
                                className="w-full bg-transparent font-clinical text-albedo placeholder:text-albedo/10 focus:outline-none uppercase tracking-widest"
                    ...
                    <div className="group border-b border-white/10 focus-within:border-visceral-crimson transition-colors pb-2">
                        <label className="font-clinical text-[10px] tracking-[0.3em] uppercase text-albedo/30 block mb-2">Intent & Background</label>
                        <textarea
                            rows="4"
                            className="w-full bg-transparent font-clinical text-albedo placeholder:text-albedo/10 focus:outline-none uppercase tracking-widest resize-none"
                    ...
                    <div className="flex gap-4 p-6 bg-visceral-crimson/5 border border-visceral-crimson/20 items-start">
                        ...
                        <p className="font-clinical text-[11px] text-albedo/40 uppercase leading-relaxed tracking-wider">
                    ...
                    {/* Submission */}
                    <button className="flex items-center gap-4 py-6 px-12 bg-white text-black hover:bg-visceral-crimson hover:text-albedo transition-all duration-500 group">
                ...
                <footer className="mt-32 pt-16 border-t border-white/5 flex flex-col md:flex-row gap-12 justify-between">
                    <div>
                        <h4 className="font-clinical text-xs tracking-widest uppercase text-albedo/60 mb-4">Direct Inquiries</h4>
                        <p className="font-clinical text-sm text-albedo/30 uppercase tracking-tighter">
                            Secure@umbramovementlab.com
                        </p>
                    </div>
                    <div>
                        <h4 className="font-clinical text-xs tracking-widest uppercase text-albedo/60 mb-4">Lab Address</h4>
                        <p className="font-clinical text-sm text-albedo/30 uppercase tracking-tighter">
